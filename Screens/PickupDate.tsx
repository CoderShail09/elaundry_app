      ...
      <SafeAreaView>
        <View style={{ height: 926, width: 428, backgroundColor: "#F3F1F6" }}>
          ...
          >
           ...
           <Box style={{width:370,height:60,borderStyle:"solid",borderColor:"#E8E8E8",borderWidth:1,left:20,bottom:40,display:"flex",flexDirection:"row",backgroundColor:"#E8E8E8",borderRadius:7}}>
