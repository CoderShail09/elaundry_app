import { View, SafeAreaView, Image, StyleSheet, TextInput, TouchableOpacity,  } from "react-native";
        ...
        <Box
          ...
          >
            ...
            <Image
              ...
              style={{ marginTop: 32, marginRight: 50, height: 22, width: 22 }}
            />
          </Box>
              ...
              <View style={{ width: 172, height: 70 }}>
                ...
                >
                  ...
                  <View style={{ marginTop: 0 }}>
                    <Text style={{ fontSize: 6, fontWeight: "400" }}>Edit</Text>
                  </View>
                </View>
                <View style={{ width: 161, height: 19, marginLeft: 8 }}>
                  <Text style={{ fontSize: 10, lineHeight: 9.5 }}>
                    GK-2 Ghyan Khand plot no-457 Floor 5th ,Near Aggarwal Sweets
                  </Text>
