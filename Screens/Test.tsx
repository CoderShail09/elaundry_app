...
const Category = () => {
      ...
      <Swipeable renderLeftActions={LeftSwipe} renderRightActions={RightSwipe}>
        ...
        >
          ...
          >
            ...
            >
              <AntDesign name="plussquareo" size={19} color="black" />
              <Text>{item.quantity}</Text>
              <AntDesign name="minussquareo" size={19} color="black" />
            </View>
          </View>
          <View
            style={{
          ...
          >
            <Text style={{ fontSize: 16, color: "#000000" }}>{item.Price}</Text>
          </View>
        </Box>
      </Swipeable>
    );
  ...
  const RightSwipe = () => {
    return (
        ...
        <Button  style={{ marginTop: 10, backgroundColor: "#002B6B", width: 50,borderRadius:7 }}>
  ...
  const LeftSwipe = () => {
    return (
      ...
      <Button style={{ marginTop: 10, backgroundColor: "cyan", width: 50 ,borderRadius:7}}>
        <Text style={{ fontSize: 16,margin:"auto" }}>Edit</Text>
      </Button>
  ...
  return (
    ...
    <SafeAreaView>
      <View style={{ height: 926, width: 428, backgroundColor: "#E5E5E5" }}>
        ...
        >
          <Button height="40px" width="73px" backgroundColor="#002B6B">
            Men's
          </Button>
          <Button
            height="40px"
       ...
       /> */}
        ...
        {/* <Box
            style={{
              ...
              flexDirection: "row",
              borderStyle: "solid",
              borderColor: "#DBFFFD80",
              borderWidth: 1,
              backgroundColor: "#DBFFFD80",
              marginLeft: 8,
            }}
          >
            <View style={{ marginLeft: 18 }}>
              <Image
                alt="product-image"
                source={require("../assets/Photos/jeans.png")}
                style={{ height: 74, width: 74 }}
              />
            </View>
            <View
            ...
            >
              <Text style={{ fontSize: 16 }}>Jeans Pant</Text>
              <View
                style={{
                  width: 39,
                  height: 24,
            ...
            >
              <Text style={{ fontSize: 16, color: "#000000" }}>₹ 150.00</Text>
            </View>
          </Box>
          ...
          <Box
            style={{
              ...
              flexDirection: "row",
              borderStyle: "solid",
              borderColor: "#E97B3E80",
              borderWidth: 1,
              backgroundColor: "#E97B3E80",
              marginLeft: 8,
            }}
          >
            <View style={{ marginLeft: 18 }}>
              <Image
                alt="product-image"
                source={require("../assets/Photos/Tshirt.png")}
                style={{ height: 74, width: 74 }}
              />
            </View>
            <View
